...
def main():
	...
	parser.add_argument('--cpus', help='Number of CPUs to use (default=1)', type = int, default = 1)
	...
	print( 'Total CPUs requested: {}'. format( args.cpus ) )
	...
	# p.map( seroTYPE, [args.fasta, seroPRIMERS, allelesDB])
	# sys.exit()
	for f in args.fasta:
