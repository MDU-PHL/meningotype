...
def finetypeBLAST(s, db):
	ft = None
	allele = None
	ftBLAST = NcbiblastxCommandline(query='-', db=db, outfmt='"6 qseqid sseqid pident length slen gaps evalue"', seg='no', query_gencode='11', matrix='PAM30', ungapped, comp_based_stats='0', evalue='1E-6', max_target_seqs='1')
